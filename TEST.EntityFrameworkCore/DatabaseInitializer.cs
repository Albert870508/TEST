...
namespace TEST.EntityFrameworkCore
{
    public static class DatabaseInitializer
    {
        ...
        /// </summary>
        /// <param name="db"></param>
        private static void InitializeAdministrators(TESTDbContext db)
        {
            List<Administrator> administrators = new List<Administrator>() {
               new Administrator(){Name = "Administrator",Password = Helper.StringTools.MD5Encrypt32("123456")}
            };
        ...
        private static void InitializeQuestionTypes(TESTDbContext db)
        {
            List<QuestionType> questionTypes = new List<QuestionType>() {
                ...
                new QuestionType(){ Name="填空", Score=2.0, Number=10 },
                new QuestionType(){ Name="简答", Score=2.0, Number=10 },
                new QuestionType(){ Name="案例分析", Score=2.0, Number=10 }
            };
        ...
        {
            var m = db.QuestionTypes.FirstOrDefault(n => n.Name == "多选");
            var r = db.QuestionTypes.FirstOrDefault(n => n.Name == "单选");
            var q = db.QuestionTypes.FirstOrDefault(n => n.Name == "判断");

            db.AddRange(new List<Question>() {
                 new Question(){
                    QuestionTypeId=r.Id,
